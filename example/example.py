...
bot=Bot("your_oauth_token","your_client_id","your_client_secret","your_redirect_uri",os.path.dirname(os.path.realpath(__file__))+"/tokens.secret","login_of_your_bot",["channels_list_to_read_from"],"!")
